...
class TripadvisorDatasetReader:
    ...
    def __init__(self, dataset='TripAdvisor_hotel', embed_dim=300, max_seq_len=-1):
        ...
        text_test, aspect_text_test, max_seq_len_test, max_term_len_test = TripadvisorDatasetReader.__read_text__(
        ...
        self.train_data = TripadvisorDataset(
            TripadvisorDatasetReader.__read_data__(fname[dataset]['train'], tokenizer_text, dataset=dataset))
        self.test_data = TripadvisorDataset(
            TripadvisorDatasetReader.__read_data__(fname[dataset]['test'], tokenizer_text, dataset=dataset))
        self.dev_data = TripadvisorDataset([])
